...
public class Controller extends VIAFitSystem
{
  ...
  @FXML
  private ListView<String> classViewList = new ListView<>();

  @FXML
  private ComboBox<String> comboBoxInstructors = new ComboBox<>();
  ...
  public void initialize(){
    ...
    instructorColumnClasses.setCellValueFactory(new PropertyValueFactory<Instructor, String>("classes"));
    ...
    comboBoxInstructors.getItems().addAll(super.getInstructorNames());
    classViewList.getItems().addAll(super.getClassNames());
  }
