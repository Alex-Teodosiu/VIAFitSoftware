...
public class Controller
{
  ...
  {
    Parent view = FXMLLoader.load(getClass().getResource("FxmlMemberList.fxml"));
  ...
  {
    Parent view = FXMLLoader.load(getClass().getResource("FxmlInstructorList.fxml"));
    Scene homeScene = new Scene(view);
  ...
  {
    Parent view = FXMLLoader.load(getClass().getResource("FxmlClassList.fxml"));
    Scene homeScene = new Scene(view);
